...
export const CSV_FIELDS = {
  ...
  ownerBirthDate: { header: "Date de naissance Owner" },
  ownerBirthPlace: { header: "Lieu de naissance Owner" },
  ownerNationality: { header: "Nationalité Owner" },
  ownerPassportNumber: { header: "Numéro Passeport Owner" },
  ownerIsCompany: { header: "Owner Société" },
  ownerCompanyName: { header: "Nom Société" },
  ownerCompanyLegalForm: { header: "Forme Société" },
  ownerCompanyCapital: { header: "Capital Société" },
  ownerCompanyAddress: { header: "Adresse Société" },
  ownerCompanySiren: { header: "SIREN Société" },
  ownerCompanyRcsCity: { header: "Ville RCS" },
  ownerCompanyRepresentedBy: { header: "Représenté par" },
  ownerCompanyRole: { header: "Qualité représentant" },
  ownerNotes: { header: "Notes Owner" },
  leaseStartDate: { header: "Date début Bail" },
  leaseInitialTerm: { header: "Durée initiale Bail" },
  leaseRenewalTerm: { header: "Durée tacite reconduction" },
  leaseRentFreePeriod: { header: "Franchise de loyer" },
  ...
  leaseTenantTerminationDelay: { header: "Délai résiliation locataire" },
