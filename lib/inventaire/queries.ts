...
const BULK_FIELD_SOURCE: Record<string, { table: string; column: string }> = {
  ...
  owner_birth_date: { table: "property_owner", column: "birth_date" },
  owner_birth_place: { table: "property_owner", column: "birth_place" },
  owner_nationality: { table: "property_owner", column: "nationality" },
  owner_passport_number: { table: "property_owner", column: "passport_number" },
  is_company: { table: "property_owner", column: "is_company" },
  company_name: { table: "property_owner", column: "company_name" },
  company_legal_form: { table: "property_owner", column: "company_legal_form" },
  company_capital: { table: "property_owner", column: "company_capital" },
  company_address: { table: "property_owner", column: "company_address" },
  company_siren: { table: "property_owner", column: "company_siren" },
  company_rcs_city: { table: "property_owner", column: "company_rcs_city" },
  company_represented_by: { table: "property_owner", column: "company_represented_by" },
  company_role: { table: "property_owner", column: "company_role" },
  owner_notes: { table: "property_owner", column: "notes" },
  lease_start_date: { table: "property_owner", column: "lease_start_date" },
  lease_initial_term: { table: "property_owner", column: "lease_initial_term" },
  lease_renewal_term: { table: "property_owner", column: "lease_renewal_term" },
  lease_rent_free_period: { table: "property_owner", column: "lease_rent_free_period" },
  ...
  lease_special_clause_1: { table: "property_owner", column: "lease_special_clause_1" },
  lease_special_clause_2: { table: "property_owner", column: "lease_special_clause_2" },
  lease_tenant_termination_delay: { table: "property_owner", column: "lease_tenant_termination_delay" },
  lease_tenant_notice: { table: "property_owner", column: "lease_tenant_notice" },
  lease_owner_termination_delay: { table: "property_owner", column: "lease_owner_termination_delay" },
  lease_owner_notice: { table: "property_owner", column: "lease_owner_notice" },
