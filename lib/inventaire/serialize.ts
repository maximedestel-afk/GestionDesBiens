...
export function serializePropertyOwner(row: any): PropertyOwner {
  return {
    ...
    companyRcsCity: row.company_rcs_city,
    companyRepresentedBy: row.company_represented_by,
    companyRole: row.company_role,
    notes: row.notes,
    leaseStartDate: row.lease_start_date,
    leaseInitialTerm: row.lease_initial_term,
    leaseRenewalTerm: row.lease_renewal_term,
    leaseRentFreePeriod: row.lease_rent_free_period,
    ...
    leaseSpecialClause1: row.lease_special_clause_1,
    leaseSpecialClause2: row.lease_special_clause_2,
    leaseTenantTerminationDelay: row.lease_tenant_termination_delay,
    leaseTenantNotice: row.lease_tenant_notice,
    leaseOwnerTerminationDelay: row.lease_owner_termination_delay,
