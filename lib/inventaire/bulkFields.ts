...
export const BULK_FIELDS: BulkFieldDef[] = [
  ...
  { id: "lease_initial_term", label: "Durée initiale du bail", group: "Propriétaire", formKey: "leaseInitialTerm", inputType: "text" },
  { id: "lease_renewal_term", label: "Durée tacite reconduction", group: "Propriétaire", formKey: "leaseRenewalTerm", inputType: "text" },
  { id: "lease_rent_free_period", label: "Franchise de loyer", group: "Propriétaire", formKey: "leaseRentFreePeriod", inputType: "text" },
  ...
  { id: "lease_tenant_notes", label: "Notes locataire", group: "Propriétaire", formKey: "leaseTenantNotes", inputType: "text" },
  { id: "lease_special_clause_1", label: "Clause particulière 1", group: "Propriétaire", formKey: "leaseSpecialClause1", inputType: "text" },
  { id: "lease_special_clause_2", label: "Clause particulière 2", group: "Propriétaire", formKey: "leaseSpecialClause2", inputType: "text" },
  { id: "lease_tenant_termination_delay", label: "Délai résiliation locataire", group: "Propriétaire", formKey: "leaseTenantTerminationDelay", inputType: "text" },
  { id: "lease_tenant_notice", label: "Préavis locataire", group: "Propriétaire", formKey: "leaseTenantNotice", inputType: "text" },
  { id: "lease_owner_termination_delay", label: "Délai résiliation bailleur", group: "Propriétaire", formKey: "leaseOwnerTerminationDelay", inputType: "text" },
  { id: "lease_owner_notice", label: "Préavis bailleur", group: "Propriétaire", formKey: "leaseOwnerNotice", inputType: "text" },
