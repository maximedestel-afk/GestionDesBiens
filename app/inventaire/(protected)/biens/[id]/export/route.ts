...
export async function GET(
  ...
  infoSheet.addRows([
    ...
    { field: "Date de naissance propriétaire", value: owner?.birthDate ?? "" },
    { field: "Lieu de naissance propriétaire", value: owner?.birthPlace ?? "" },
    { field: "Nationalité propriétaire", value: owner?.nationality ?? "" },
    { field: "Numéro de passeport propriétaire", value: owner?.passportNumber ?? "" },
    { field: "Nom société", value: owner?.companyName ?? "" },
    { field: "Forme société", value: owner?.companyLegalForm ?? "" },
    { field: "Capital société", value: owner?.companyCapital ?? "" },
    { field: "Adresse société", value: owner?.companyAddress ?? "" },
    { field: "SIREN société", value: owner?.companySiren ?? "" },
    { field: "Ville RCS", value: owner?.companyRcsCity ?? "" },
    { field: "Représenté par", value: owner?.companyRepresentedBy ?? "" },
    { field: "Qualité", value: owner?.companyRole ?? "" },
