import { getAllowedSectionsForRole, getCurrentProfile, listAllActivityLog } from "@/lib/inventaire/queries";
...
export default async function JournalPage({
  ...
  if (!canAccessSection(profile?.role, allowedSections, "menu_journal")) {
